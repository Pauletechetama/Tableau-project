...
# Dataset
The dataset contains 8 sheets that includes co2 data cleaned, co2(kt)pivoted co2(kt)raw data and others but i used the co2 data cleaned sheet which contains 6 columns that includes Country name, Region, Year, Country code and others, with 11127 rows of Co2 emission across different regions in different countries and different years. This dataset can be found on below links.  When you open the dataset below, you will immediately see the About page load with a single URL code at the top,please navigate to the bottom of the document and you can access all the raw and cleaned co2 data by clicking on different sheets.
